...
public class Lanes_Intersection {
    public static void main(String[] args) {
        ...
        DataTransfer p_o4N = new DataTransfer();
        p_o4N.SetName("p_o4N");
        p_o4N.Value = new TransferOperation("localhost", "1082", "P1");
        pn.PlaceList.add(p_o4N);
        ...
        // Add full signal over network for controller OP1
        ...
        grdT1_2.Activations.add(new Activation(t1, "P_a1", TransitionOperation.Move, "P_a1"));
...
//		t2.Delay = 3;
        ...
        // Add full signal over network for controller OP2
        ...
        grdT2_2.condition = T1Ct3;
        grdT2_2.Activations.add(new Activation(t3, "full", TransitionOperation.SendOverNetwork, "OP2"));
        grdT2_2.Activations.add(new Activation(t3, "P_a2", TransitionOperation.Move, "P_a2"));
        ...
        // Add full signal over network for controller OP3
        ...
        grdT5_2.condition = T5Ct3;
        grdT5_2.Activations.add(new Activation(t5, "full", TransitionOperation.SendOverNetwork, "OP3"));
        grdT5_2.Activations.add(new Activation(t5, "P_a3", TransitionOperation.Move, "P_a3"));
        ...
        // Add full signal over network for controller OP4
        ...
        grdT7_2.condition = T7Ct3;
        grdT7_2.Activations.add(new Activation(t7, "full", TransitionOperation.SendOverNetwork, "OP4"));
        grdT7_2.Activations.add(new Activation(t7, "P_a4", TransitionOperation.Move, "P_a4"));
        ...
        // Tg4n ------------------------------------------------
        PetriTransition tg4n = new PetriTransition(pn);
        tg4n.TransitionName = "t_g4n";
        tg4n.InputPlaceName.add("P_o4Exit");

        Condition tg4nCt1 = new Condition(tg4n, "P_o4Exit", TransitionCondition.NotNull);
        GuardMapping grdTg4n = new GuardMapping();

        grdTg4n.condition = tg4nCt1;
        grdTg4n.Activations.add(new Activation(tg4n, "P_o4Exit", TransitionOperation.SendOverNetwork, "p_o4N"));
        tg4n.GuardMappingList.add(grdTg4n);

        tg4n.Delay = 0;
        pn.Transitions.add(tg4n);
