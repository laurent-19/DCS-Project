...
public class Lane {
	public static void main(String[] args) {
		...
		grdT12.Activations.add(new Activation(t1, "full", TransitionOperation.SendOverNetwork, "OP"));
		grdT12.Activations.add(new Activation(t1, "P_a1", TransitionOperation.Move, "P_a1"));
